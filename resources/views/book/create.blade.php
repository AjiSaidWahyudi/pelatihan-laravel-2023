...
<body>
    <div class="container">
        ...
        <form action="{{route('book.store')}}" method="post" enctype="multipart/form-data">
            ...
            @enderror
            <br>
            <input type="text" name="author" id="" class="form-control @error('author') is-invalid @enderror" placeholder="Book Author">
            @error('author')
                <div class="alert alert-danger">{{$message}}</div>
            @enderror
            <br>
            <input type="text" name="location" id="" class="form-control @error('location') is-invalid @enderror" placeholder="Location Released">
            @error('location')
                <div class="alert alert-danger">{{$message}}</div>
            @enderror
            <br>
            <input type="text" name="year" id="" class="form-control @error('year') is-invalid @enderror" placeholder="Year Released">
            @error('year')
                <div class="alert alert-danger">{{$message}}</div>
            @enderror
            <br>
